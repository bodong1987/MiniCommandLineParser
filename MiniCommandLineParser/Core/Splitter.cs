...
/// <summary>
/// Provides methods for splitting command-line strings into individual arguments.
/// </summary>
public static class Splitter
{
    ...
    /// <summary>
    /// Splits a command-line string into a list of arguments with detection of illegal characters.
    /// </summary>
    /// <param name="commandLine">The command-line string to split.</param>
    /// <param name="removeHashComments">If <c>true</c>, text after '#' is treated as a comment and removed.</param>
    /// <param name="illegalChar">When this method returns, contains the first illegal character found, or <c>null</c> if none.</param>
    ...
    /// <summary>
    /// Splits a command-line span into arguments using the provided builder and list for efficiency.
    /// </summary>
    /// <param name="commandLine">The command-line character span to split.</param>
    /// <param name="removeHashComments">If <c>true</c>, text after '#' is treated as a comment and removed.</param>
    /// <param name="builder">A <see cref="StringBuilder"/> used for building individual arguments.</param>
    /// <param name="list">The list to populate with parsed arguments.</param>
    /// <param name="illegalChar">When this method returns, contains the first illegal character found, or <c>null</c> if none.</param>
